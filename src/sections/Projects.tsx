          ...
          >
            {projects.map((project, idx) => (
              <motion.div
                ...
                className="group relative flex flex-col justify-between glass p-6 md:p-8 rounded-2xl border border-border/40 hover:border-border/80 shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden"
              >
                {/* Visual glow overlay */}
